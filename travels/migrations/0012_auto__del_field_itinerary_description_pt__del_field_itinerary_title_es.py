...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Itinerary.title_tr'
        db.add_column(u'travels_itinerary', 'title_tr', self.gf('django.db.models.fields.CharField')(max_length=160, null=True, blank=True), keep_default=False)

        # Adding field 'Itinerary.description_tr'
        db.add_column(u'travels_itinerary', 'description_tr', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Cast.title_tr'
        db.add_column(u'travels_cast', 'title_tr', self.gf('django.db.models.fields.CharField')(max_length=160, null=True, blank=True), keep_default=False)

        # Adding field 'Cast.description_tr'
        db.add_column(u'travels_cast', 'description_tr', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Settings.project_title_tr'
        db.add_column(u'travels_settings', 'project_title_tr', self.gf('django.db.models.fields.CharField')(default="Welcome to UNICEF's Youth Led Digital Mapping", max_length=256, null=True, blank=True), keep_default=False)

        # Adding field 'Settings.project_description_tr'
        db.add_column(u'travels_settings', 'project_description_tr', self.gf('django.db.models.fields.TextField')(default='This project explores tools to help youth build impactful, communicative digital maps using mobile and web technologies. A phone application allows youth to produce a realtime portrait of their community through geo-located photos and videos, organized in thematic maps.', null=True, blank=True), keep_default=False)

        # Adding field 'Settings.window_title_tr'
        db.add_column(u'travels_settings', 'window_title_tr', self.gf('django.db.models.fields.CharField')(default="UNICEF's Youth Led Digital Mapping", max_length=256, null=True, blank=True), keep_default=False)

        # Adding field 'Event.title_tr'
        db.add_column(u'travels_event', 'title_tr', self.gf('django.db.models.fields.CharField')(max_length=160, null=True, blank=True), keep_default=False)

        # Adding field 'Event.description_tr'
        db.add_column(u'travels_event', 'description_tr', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Itinerary.title_tr'
        db.delete_column(u'travels_itinerary', 'title_tr')

        # Deleting field 'Itinerary.description_tr'
        db.delete_column(u'travels_itinerary', 'description_tr')

        # Deleting field 'Cast.title_tr'
        db.delete_column(u'travels_cast', 'title_tr')

        # Deleting field 'Cast.description_tr'
        db.delete_column(u'travels_cast', 'description_tr')

        # Deleting field 'Settings.project_title_tr'
        db.delete_column(u'travels_settings', 'project_title_tr')

        # Deleting field 'Settings.project_description_tr'
        db.delete_column(u'travels_settings', 'project_description_tr')

        # Deleting field 'Settings.window_title_tr'
        db.delete_column(u'travels_settings', 'window_title_tr')

        # Deleting field 'Event.title_tr'
        db.delete_column(u'travels_event', 'title_tr')

        # Deleting field 'Event.description_tr'
        db.delete_column(u'travels_event', 'description_tr')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 29, 15, 44, 45, 925075)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 29, 15, 44, 45, 924716)'}),
