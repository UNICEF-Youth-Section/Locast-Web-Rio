...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Itinerary.title_ar'
        db.add_column(u'travels_itinerary', 'title_ar', self.gf('django.db.models.fields.CharField')(max_length=160, null=True, blank=True), keep_default=False)

        # Adding field 'Itinerary.description_ar'
        db.add_column(u'travels_itinerary', 'description_ar', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Cast.title_ar'
        db.add_column(u'travels_cast', 'title_ar', self.gf('django.db.models.fields.CharField')(max_length=160, null=True, blank=True), keep_default=False)

        # Adding field 'Cast.description_ar'
        db.add_column(u'travels_cast', 'description_ar', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Settings.project_title_ar'
        db.add_column(u'travels_settings', 'project_title_ar', self.gf('django.db.models.fields.CharField')(default="Welcome to UNICEF's Youth Led Digital Mapping", max_length=256, null=True, blank=True), keep_default=False)

        # Adding field 'Settings.project_description_ar'
        db.add_column(u'travels_settings', 'project_description_ar', self.gf('django.db.models.fields.TextField')(default='This project explores tools to help youth build impactful, communicative digital maps using mobile and web technologies. A phone application allows youth to produce a realtime portrait of their community through geo-located photos and videos, organized in thematic maps.', null=True, blank=True), keep_default=False)

        # Adding field 'Settings.window_title_ar'
        db.add_column(u'travels_settings', 'window_title_ar', self.gf('django.db.models.fields.CharField')(default="UNICEF's Youth Led Digital Mapping", max_length=256, null=True, blank=True), keep_default=False)

        # Adding field 'Event.title_ar'
        db.add_column(u'travels_event', 'title_ar', self.gf('django.db.models.fields.CharField')(max_length=160, null=True, blank=True), keep_default=False)

        # Adding field 'Event.description_ar'
        db.add_column(u'travels_event', 'description_ar', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Itinerary.title_ar'
        db.delete_column(u'travels_itinerary', 'title_ar')

        # Deleting field 'Itinerary.description_ar'
        db.delete_column(u'travels_itinerary', 'description_ar')

        # Deleting field 'Cast.title_ar'
        db.delete_column(u'travels_cast', 'title_ar')

        # Deleting field 'Cast.description_ar'
        db.delete_column(u'travels_cast', 'description_ar')

        # Deleting field 'Settings.project_title_ar'
        db.delete_column(u'travels_settings', 'project_title_ar')

        # Deleting field 'Settings.project_description_ar'
        db.delete_column(u'travels_settings', 'project_description_ar')

        # Deleting field 'Settings.window_title_ar'
        db.delete_column(u'travels_settings', 'window_title_ar')

        # Deleting field 'Event.title_ar'
        db.delete_column(u'travels_event', 'title_ar')

        # Deleting field 'Event.description_ar'
        db.delete_column(u'travels_event', 'description_ar')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 30, 18, 21, 41, 575095)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 30, 18, 21, 41, 574777)'}),
        ...
        u'travels.cast': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'max_length': '160'}),
            'title_ar': ('django.db.models.fields.CharField', [], {'max_length': '160', 'null': 'True', 'blank': 'True'}),
            ...
            'title_tr': ('django.db.models.fields.CharField', [], {'max_length': '160', 'null': 'True', 'blank': 'True'})
        },
        u'travels.comment': {
        ...
        u'travels.settings': {
            ...
            'project_title_ar': ('django.db.models.fields.CharField', [], {'default': '"Welcome to UNICEF\'s Youth Led Digital Mapping"', 'max_length': '256', 'null': 'True', 'blank': 'True'}),
            ...
            'project_title_tr': ('django.db.models.fields.CharField', [], {'default': '"Welcome to UNICEF\'s Youth Led Digital Mapping"', 'max_length': '256', 'null': 'True', 'blank': 'True'}),
            'window_title': ('django.db.models.fields.CharField', [], {'default': '"UNICEF\'s Youth Led Digital Mapping"', 'max_length': '256', 'blank': 'True'}),
            'window_title_ar': ('django.db.models.fields.CharField', [], {'default': '"UNICEF\'s Youth Led Digital Mapping"', 'max_length': '256', 'null': 'True', 'blank': 'True'}),
            ...
            'window_title_tr': ('django.db.models.fields.CharField', [], {'default': '"UNICEF\'s Youth Led Digital Mapping"', 'max_length': '256', 'null': 'True', 'blank': 'True'})
        },
        u'travels.tag': {
